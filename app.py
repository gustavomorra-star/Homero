...
with tab_egresos:
    ...
    if df_egr.empty:
        ...
        if destino_seleccionado != "":
            ...
            # DESGLOSE VERTICAL CON SALTOS DE LÍNEA (\n)
...
with tab_registros:
    ...
    if df_auditoria.empty: 
        ...
        # Extracción segura sin comandos .iloc directo sobre el array
        ...
        with col_ed3:
            val_actual_finalidad = str(fila_real["finalidad"].values[0])
